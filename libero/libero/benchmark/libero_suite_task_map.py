libero_task_map = {
    ...
    "my_suite": [
        # T1: Push+Pick Board - Push object to wall contact
        "push_the_blue_box_to_the_front_of_the_wall",
        # T2: Pick+Place Box - Basic pick and place
        "pick_and_place_box",
        # T3: Pick+Place Clutter - Pick and place with distractors
        "pick_and_place_clutter",
        # T4: Push Const. Force - Pushing with constant force
        "push_with_constant_force",
        # T5: Flip Box - Flip using wall contact
        "flip_the_blue_box_onto_its_side",
        # Complex: Combined push and flip
